...
/**
 * 微信公众平台的授权请求 {@link AuthRequest} 实现
 *
 * @author yuchao
 */
@Component
public class WeChatMpAuthRequestBuilder implements AuthRequestBuilder {

    @Override
    public boolean support(Integer socialType) {
        return SocialTypeEnum.WECHAT_MP.getType().equals(socialType);
    }
