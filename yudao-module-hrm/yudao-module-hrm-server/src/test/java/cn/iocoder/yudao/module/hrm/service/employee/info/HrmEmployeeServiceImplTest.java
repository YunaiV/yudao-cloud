...
import cn.iocoder.yudao.module.hrm.controller.admin.employee.vo.employee.*;
...
import cn.iocoder.yudao.module.hrm.enums.employee.info.*;
...
public class HrmEmployeeServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateEmployeeList_success() {
        ...
        when(adminUserApi.getUserList(argThat(ids -> ids.containsAll(asList(firstUser.getId(), secondUser.getId())))))
                .thenReturn(success(asList(firstUser, secondUser)));
        doAnswer(invocation -> {
    ...
    public void testImportEmployeeList_resolvesBusinessReferences() {
        ...
        when(adminUserApi.getUserByMobile(user.getMobile())).thenReturn(success(user));
