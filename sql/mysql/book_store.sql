...
DROP TABLE IF EXISTS store_bookinfo;
...
insert into store_bookinfo(isbn, title, author, press, publish_date, price, brief_intro) values(9787111608523, 'Docker技术入门与实战（第3版）', '杨保华，戴王剑，曹亚仑 著', '机械工业出版社', '2018-09-01', 69, '本书从Docker基本原理开始，深入浅出地讲解Docker的构建与操作，内容系统全面，可帮助开发人员、运维人员快速部署Docker应用。本书分为四大部分：基础入门、实战案例、进阶技能、开源项目。第3版根据 Docker 18.x 系列版本对全书内容进行了全面修订。');
